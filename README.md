...
Every source file under `src/` (including the renderer) and `tools/`, plus the CMake build
scripts, carries an `SPDX-License-Identifier: GPL-3.0-or-later` header.
Bundled and depended-upon third-party components keep their own licenses; they
